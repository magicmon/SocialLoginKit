...
#define NAVERAUTH_BUNDLE                [NSBundle bundleWithURL:[[NSBundle mainBundle] URLForResource:@"Frameworks/SocialLoginKit.framework/NaverAuth" withExtension:@"bundle"]]
...
- (void)makeBottomBar   {
    ...
    UIImage *loginBackground = [UIImage imageNamed:@"Frameworks/SocialLoginKit.framework/NaverAuth.bundle/login_bg_2.png"];
    ...
    [_closeBt setBackgroundImage:[UIImage imageNamed:@"Frameworks/SocialLoginKit.framework/NaverAuth.bundle/login_ico_on_4.png"] forState:UIControlStateNormal];
...
- (void)makeBannerView
{
    ...
    naverAppIconView.image = [UIImage imageNamed:@"Frameworks/SocialLoginKit.framework/NaverAuth.bundle/login_naverapp_logo.png"];
    ...
    UIImageView *closeImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Frameworks/SocialLoginKit.framework/NaverAuth.bundle/login_banner_btn_close.png"]];
